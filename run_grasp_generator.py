import argparse
from utils.dataset_processing.grasp_generator import GraspGenerator
...
def parse_args():
	...
	parser.add_argument('--use-depth', type=bool, default=False, help='Use Depth image for model (1/0)')
	...
	parser.add_argument('--network-path', type=str, default='/home/capture/WidowX_OpenDay_Demo/robot/trained_models/GRConv_RGBD_Pos_1bin/epoch_33_iou_0.91', help='Path to trained network')
