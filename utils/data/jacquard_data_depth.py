...
from .grasp_data_depth import GraspDatasetBase
...
class JacquardDataset(GraspDatasetBase):
	...
	def __init__(self, file_path, **kwargs):
		...
		salf = [f.replace('perfect_depth.tiff', 'mask.png') for f in depthf]
	...
	def get_sal(self, idx, rot=0, zoom=1.0):
		sal_img = image.Image.from_file(self.sal_files[idx])
		sal_img.rotate(rot)
		sal_img.sal_normalise()
		sal_img.zoom(zoom)
